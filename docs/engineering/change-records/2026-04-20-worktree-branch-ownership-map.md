...
| PRD-45 | `/Users/bm/Documents/daily-intelligence-aggregator-password-reset` | `feature/prd-45-password-reset-flow` | `origin/feature/prd-45-password-reset-flow` | `8d450a4` | Canonical prepared for merge sequencing after PRD-44 merge; draft PR #80 open for preview and human reset-flow validation |
