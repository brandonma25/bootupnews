...
async function main() {
  ...
  console.log(JSON.stringify({
    ...
    candidate_pool_insufficient_reason: report.candidate_pool_insufficient_reason,
    sourceScarcityLikely: report.selectionSummary.sourceScarcityLikely,
    sourceAccessibilityLikely: report.selectionSummary.sourceAccessibilityLikely,
    sourceAccessibilityWarnings: report.selectionSummary.sourceAccessibilityWarnings,
    functionalSourceCoverageByCategory: report.selectionSummary.functionalSourceCoverageByCategory,
